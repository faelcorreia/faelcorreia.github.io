...
class playGame extends Phaser.Scene {
    ...
    preload() {
        this.load.image("background", "assets/junina.jpeg");
        this.load.image("platform", "assets/asfalto.png");
        this.load.image("player", "assets/silver.png");
        this.load.audio("song", "assets/quadrilha.mp3");
        this.load.audio("gritim", "assets/gritim.ogg");
    ...
    create() {
        ...
        this.player.displayWidth = 150;
        this.player.displayHeight = 150 * ratio;
